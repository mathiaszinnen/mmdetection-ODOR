...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'coco-style/annotations/instances_train2017.json',
        img_prefix=data_root + 'coco-style/train2017/',
    ...
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'coco-style/annotations/instances_val2017.json',
        img_prefix=data_root + 'coco-style/val2017',
        pipeline=test_pipeline))
